...
import { Menu, X, Search, MapPin, Heart } from 'lucide-react';
...
export default function PostsPage() {
  ...
  const allPosts = [
    {
      id: 1,
      title: 'Spacious 2-bedroom apartment downtown',
      type: 'Apartment',
      wilaya: 'Alger',
      price: '45,000 DA',
      ...
      description: 'Beautiful apartment with natural light and modern amenities'
    },
    {
      id: 2,
      title: 'Quiet room in shared house',
      type: 'Room',
      wilaya: 'Oran',
      price: '20,000 DA',
      ...
      description: 'Comfortable room in a peaceful neighborhood'
    },
    {
      id: 3,
      ...
      description: 'Stylish studio apartment perfect for professionals'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      type: 'Request',
      wilaya: 'Alger',
      price: '35,000 - 50,000 DA',
      tags: ['Wanted', 'Near Metro', 'City Center'],
      timeAgo: '1 day ago',
      user: 'Karim Djamel',
      image: 'https://images.unsplash.com/photo-1515263487990-61b07816b324?w=400&h=300&fit=crop',
      description: 'Professional seeking comfortable 1-bedroom apartment'
    },
  ];
        ...
        <nav className="bg-white border-b border-gray-200 sticky top-0 z-20">
          <div className="px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="/posts" className="text-gray-900 font-medium">
                All Posts
              </a>
            </div>

            <div className="text-gray-500 text-sm hidden md:block">
              Created by MorenaDev
            </div>
          </div>
        </nav>
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden bg-gray-200">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-black text-white px-3 py-1 rounded text-xs font-semibold">
                      {post.type}
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-black">
                      {post.title}
                    </h3>
