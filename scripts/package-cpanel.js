...
console.log('📋 Step 4.5: Copying Next.js BUILD_ID, complete .next/server manifests and chunks into standalone/.next...');
...
const targetDotNextServerDir = path.join(targetDotNextDir, 'server');
if (fs.existsSync(dotNextServerDir)) {
  fs.cpSync(dotNextServerDir, targetDotNextServerDir, { recursive: true, force: true });
}
